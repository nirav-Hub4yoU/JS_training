...
window.addEventListener("DOMContentLoaded", function(){
    containerMenu = document.querySelector('#listing')
    menuListing  = document.querySelector('#food-list')
...
function appendMenuItems(menu){
    const menuListingNew  = menu.map((m)=>{
        return `
        <article>
<img src=${m.img} alt="" />
<div class="item-info">
  ...
  <p class="item-text">${m.desc}</p>
</div>
</article> 
        `
    })
menuListing.innerHTML=menuListingNew
}